...
"""
RTC_DS1307_HD.py 
Version modifiée de la classe RTC_DS1307.py par Hervé Dugast  v 1.0
Date : 11-01-2017
Ajout d'une méthode pour formater une chaine contenant date et heure
Code inspired from GitHub: https://gist.github.com/sorz/6049584
"""
...
class RTC():
    ...
    def getDateStrFr(self):
        '''
        Returns the current date/time.
        @return: date/time in a string with format
        year-month-day hours:minutes:seconds
        '''
        return "%02d-%02d-20%02d %02d:%02d:%02d" %(self.getDay(), self.getMonth(), self.getYear(), self.getHours(), self.getMinutes(), self.getSeconds())
        
    def getDayTextFr(self):
        """
        ...
        return switcher.get(bcdToInt(self._read(self._REG_DOW)), "nothing")
