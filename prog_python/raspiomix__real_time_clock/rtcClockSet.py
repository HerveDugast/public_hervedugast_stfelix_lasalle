...
# coding: utf-8
"""
Programme : rtcClockSet.py       version 1.1
Date : 30-01-2018
Auteur : Hervé Dugast
...
Fonctionnement programme :
  met l'horloge DS1307 à l'heure indiquée dans le programme

------- affichage console -------------------
Avant mise à l'heure : 2018-01-31 10:25:23
Après mise à l'heure : 2018-01-31 10:30:00
---------------------------------------------
...
# dow/jour semaine  1:dimanche  2:lundi 3:mardi  4:mercredi  5:jeudi  6:vendredi  7:samedi
dat = {"jourSem":4, "jour":31, "mois":1, "annee":18, "heure":10, "minute":30, "seconde":0}

rtc = RTC()
print("Avant mise à l'heure :", rtc.getDateStr())
rtc.setDate(seconds = dat["seconde"], minutes = dat["minute"], hours = dat["heure"], \
            dow = dat["jourSem"], day = dat["jour"], month = dat["mois"], year = dat["annee"])
print("Après mise à l'heure :", rtc.getDateStr())
